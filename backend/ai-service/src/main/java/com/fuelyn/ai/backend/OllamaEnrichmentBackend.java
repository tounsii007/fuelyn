 ...
 * </ul>
 *
 * <p>This bean is created only when {@code fuelyn.ai.ollama.enabled}
 * is {@code true}, so the absence of an Ollama container does not
 * break the service.</p>
 */
@Component
@ConditionalOnProperty(prefix = "fuelyn.ai.ollama", name = "enabled", havingValue = "true", matchIfMissing = false)
