 ...
 *
 * <p>Accepts price data and context, returns a structured recommendation. Falls back to local
 * heuristic on any AI failure &mdash; guaranteed response.
 */
@RestController
...
public class AIAdvisorController {
     ...
     *
     * <p>Returns a fuel recommendation. Always succeeds &mdash; uses fallback on error.
     */
    @PostMapping("/advisor")
    public ResponseEntity<ApiResponse<AIAdvisorResponse>> getAdvice(
        ...
        log.info(
                "[{}] AI advisor request: fuelType={}, prices={}, lat={}, lng={}",
                requestId,
                request.fuelType(),
        ...
        try {
            ...
            log.info(
                    "[{}] AI response: action={}, confidence={}, fromAI={}, fromCache={}",
                    requestId,
                    result.action(),
                    result.confidence(),
                    result.fromAI(),
