...
class LocalHeuristicFallbackTest {
    ...
    void analyze_pointsAtCheapestStation() {
        ...
        AIAdvisorRequest req =
                new AIAdvisorRequest(List.of(aral, shell, jet), "e10", null, 52.5, 13.4, 50);
    ...
    void analyze_savingsReflectsPriceSpread() {
        ...
        AIAdvisorRequest req =
                new AIAdvisorRequest(List.of(cheap, expensive), "e10", null, 52.5, 13.4, 50);
    ...
    void analyze_confidenceScalesWithDataSize() {
        List<AIAdvisorRequest.StationPrice> many =
                IntStream.range(0, 10)
                        .mapToObj(
                                i ->
                                        new AIAdvisorRequest.StationPrice(
                                                "S" + i, "Brand", 1.70 + i * 0.01, i))
                        .toList();
    ...
    void trend_detectsRisingPrices() {
        ...
        assertThat(trend.direction())
                .isEqualTo(com.fuelyn.ai.signals.EwmaChangePoint.Direction.RISING);
    ...
    void trend_detectsFallingPrices() {
        ...
        assertThat(trend.direction())
                .isEqualTo(com.fuelyn.ai.signals.EwmaChangePoint.Direction.FALLING);
    ...
    void trend_treatsFlatHistoryAsStable() {
        ...
        assertThat(trend.direction())
                .isEqualTo(com.fuelyn.ai.signals.EwmaChangePoint.Direction.STABLE);
    }

    @Test
    void trend_returnsStableForTooFewPoints() {
        var trend =
                LocalHeuristicFallback.analyseTrend(
                        List.of(
    ...
    void distancePenalty_surfacesInTipWhenDetourDoesNotPayOff() {
        ...
        AIAdvisorRequest req =
                new AIAdvisorRequest(List.of(nearby, farCheap), "e10", null, 52.5, 13.4, 50);
    ...
    private static List<AIAdvisorRequest.PricePoint> buildLinearHistory(
    ...
    private static String ts(int hoursAgo) {
        return OffsetDateTime.ofInstant(
                        Instant.now().minusSeconds(3_600L * hoursAgo), ZoneOffset.UTC)
                .toString();
    }
}
