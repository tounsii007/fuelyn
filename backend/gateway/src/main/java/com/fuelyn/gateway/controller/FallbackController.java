...
public class FallbackController {
    ...
    @RequestMapping(path = "/price-service", method = {RequestMethod.GET, RequestMethod.POST})
    ...
    @RequestMapping(path = "/ai-service", method = {RequestMethod.GET, RequestMethod.POST})
