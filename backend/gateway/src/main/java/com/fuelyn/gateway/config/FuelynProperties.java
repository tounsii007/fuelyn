...
public class FuelynProperties {
    ...
    public static class Security {
        ...
        /**
         * CIDRs from which X-Forwarded-For will be honoured. Empty by default — direct callers
         * cannot spoof their source IP for rate-limit purposes. Configure with the upstream LB /
         * CDN ranges when running behind one.
         */
    ...
    public static class Gateway {
        ...
        public static class RateLimit {
            ...
            public void setRequestsPerSecond(int r) {
                this.requestsPerSecond = r;
            }
            ...
            public void setBurstCapacity(int b) {
                this.burstCapacity = b;
            }
        }
    }
}
