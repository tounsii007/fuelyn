...
/**
 * Adds security headers to all responses. Prevents XSS, clickjacking, MIME sniffing, and enforces
 * HTTPS.
 */
@Component
public class SecurityHeadersFilter implements GlobalFilter, Ordered {
    ...
    /**
     * Whether to emit Strict-Transport-Security. Off by default — HSTS on a plain-HTTP local dev
     * setup pins browsers into HTTPS-only that doesn't exist yet. Production deployments behind TLS
     * termination should set fuelyn.gateway.security.hsts-enabled=true.
     */
    ...
    public SecurityHeadersFilter(
        ...
        this.hstsValue = "max-age=" + hstsMaxAge + (includeSub ? "; includeSubDomains" : "");
    }
