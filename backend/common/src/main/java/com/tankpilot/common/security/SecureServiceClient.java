...
import com.tankpilot.common.exception.ExternalApiException;
...
public class SecureServiceClient {
    ...
    public SecureServiceClient(RestTemplate restTemplate,
                               ...
                               @Value("${tankpilot.security.hmac-secret}") String hmacSecret,
                               @Value("${tankpilot.security.service-id}") String serviceId) {
