 ...
 * <ul>
 *   <li>{@code tankpilot.rate-limit.requests-per-minute} - maximum requests per minute per IP (default: 60)</li>
 *   <li>{@code tankpilot.rate-limit.enabled} - enable/disable rate limiting (default: true)</li>
 * </ul>
 *
 * <h3>Algorithm</h3>
 ...
 * </ul>
 *
 * @see com.tankpilot.common.exception.RateLimitExceededException
 */
@Configuration
public class RateLimiterConfig {
    ...
    public RateLimiterFilter rateLimiterFilter(
            @Value("${tankpilot.rate-limit.requests-per-minute:60}") int requestsPerMinute,
            @Value("${tankpilot.rate-limit.enabled:true}") boolean enabled) {
