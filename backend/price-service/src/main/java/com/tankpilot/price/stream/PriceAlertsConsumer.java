...
/**
 * Second consumer of {@code tankpilot.prices.v1}: scans every
...
public class PriceAlertsConsumer {
    ...
    @KafkaListener(
            topics = "${tankpilot.kafka.prices-topic:tankpilot.prices.v1}",
            containerFactory = "priceStreamListenerFactory",
            groupId = "${tankpilot.kafka.consumer.alerts-group-id:price-alerts}"
    )
