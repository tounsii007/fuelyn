...
public class TankerkoenigClient implements FuelStationClient {
    ...
    public TankerkoenigClient(
            ...
            @Value("${tankpilot.tankerkoenig.base-url}") String baseUrl,
            @Value("${tankpilot.tankerkoenig.api-key}") String apiKey,
            @Value("${tankpilot.tankerkoenig.timeout-ms:10000}") int timeoutMs
    ) {
