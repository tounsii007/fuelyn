package com.tankpilot.price.scheduler;
...
import com.tankpilot.price.service.PriceCollectorService;
 ...
 */
@Component
@ConditionalOnProperty(name = "tankpilot.collection.enabled", havingValue = "true")
public class PriceCollectionScheduler {
    ...
    @Scheduled(cron = "${tankpilot.collection.cron}")
