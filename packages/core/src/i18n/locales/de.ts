...
export const de = {
  ...
  premium: {
    ...
    annualSavingsBadge: '−37 % gegenüber monatlich',
    ...
    featureTitles: {
      ...
      'multi-vehicle-fleet':   'Flotten-Verwaltung',
      'wallet-pass':           'Apple/Google Wallet Pass',
      'voice-pro':             'Hands-free Sprachsteuerung',
      'border-crossing-live':  'Live-Auslandspreise',
      'carbon-offset-buy':     'CO₂-Kompensation kaufen',
      'csv-export':            'Unbegrenzter CSV-Export',
      'wrapped-pdf':           'Wrapped als PDF',
      'api-access':            'Persönlicher API-Schlüssel',
    },
  },
