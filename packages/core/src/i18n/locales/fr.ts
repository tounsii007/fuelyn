...
export const fr: TranslationKeys = {
  ...
  vehicle: {
    ...
    modelPlaceholder: 'Saisir une marque ou un modèle…',
    driveTypeLabel: 'Motorisation',
    driveTypeFormLabel: 'Type de motorisation',
    energyType: 'Type d’énergie',
    electricity: 'Électrique',
    hydrogen: 'Hydrogène',
    fuelType: 'Carburant',
    fuelTypeShort: 'Carburant',
    consumption: 'Consommation moyenne',
    consumptionShort: 'Consommation',
    ...
    tankCapacityWithUnit: 'Capacité du réservoir en litres',
    tankCapacityUnit: 'litres',
    tankCapacityPlaceholder: 'Ex. : 50',
    tankCapacityOptional: 'facultatif',
    batteryCapacity: 'Batterie',
    batteryCapacityWithUnit: 'Capacité de la batterie en kWh',
    batteryCapacityUnit: 'kWh',
    batteryCapacityPlaceholderElectric: 'Ex. : 77',
    batteryCapacityPlaceholderHybrid: 'Ex. : 13',
    range: 'Autonomie',
    ...
    fuelLevelPlaceholderKm: 'Ex. : 350',
    fuelLevelPlaceholderLiters: 'Ex. : 25',
    fuelLevelPlaceholderPercent: 'Ex. : 50',
  ...
  memberships: {
    ...
    discoverCta: 'Pas encore de carte ? Découvrir les offres partenaires',
    cards: {
  ...
  achievements: {
    ...
    items: {
      ...
      'streak-3':             { label: 'Série futée : 3',      desc: '3 pleins d’affilée sous le marché.' },
      'streak-7':             { label: 'Série futée : 7',      desc: 'Une semaine de timing parfait.' },
      'streak-14':            { label: 'Série futée : 14',     desc: 'Deux semaines de bonnes affaires.' },
  ...
  premium: {
    ...
    annualLabel: 'Annuel',
    annualSavingsBadge: '−{pct} % vs mensuel',
  ...
  voice: {
    ...
    intents: {
      ...
      'show-fuel-log':       'Ouvrir le journal de carburant',
  ...
  openingHours: {
    allDayHeading: 'Ouverte 24 h/24 (7 j/7)',
  ...
  fuelCostCalc: {
    title: 'Calculateur de coût carburant',
    distance: 'Distance',
    distanceUnit: 'km',
    price: 'Prix',
    priceUnit: '€/L',
    ...
    cost: 'Coût',
    summary: '{cost} € pour 100 km · {consumption} L/100 km',
  },

  consumptionTracker: {
    title: 'Suivi de consommation',
    subtitle: 'Enregistrer les pleins & suivre la consommation',
    addEntryCta: '+ Entrée',
    consumptionFootnote: 'Calculé sur {entries} entrées · {km} km',
    statSpend: 'Dépenses',
    statLiters: 'Litres',
    statAvgPrice: 'Prix moy.',
    formStation: 'Station',
    formStationPlaceholder: 'Ex. : Total rue Principale',
    formFuel: 'Carburant',
    formLiters: 'Litres',
    formPrice: 'Prix (€/L)',
    formOdometer: 'Compteur (km)',
    formOdometerOptional: '(facultatif)',
    formTotal: 'Total :',
    recentEntries: 'Dernières entrées',
    removeEntryAria: 'Supprimer l’entrée',
    viewAll: 'Voir les {n} entrées',
    emptyTitle: 'Aucun plein enregistré.',
    emptyCta: 'Enregistrer votre premier plein',
  },

  wrappedNoData: {
    title: 'Pas encore assez de données.',
    body: 'Il nous faut au moins 3 entrées dans votre journal carburant avant de pouvoir raconter votre année en chiffres. Enregistrez votre dernier plein — puis revenez ici.',
    openFuelLog: 'Ouvrir le journal carburant',
    toMap: 'Retour à la carte',
  },
} as const;
