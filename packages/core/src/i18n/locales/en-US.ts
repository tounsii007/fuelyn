...
export const enUS: TranslationKeys = {
  ...
  vehicle: {
    ...
    tankCapacityWithUnit: 'Tank capacity in liters',
  ...
  partners: {
    ...
    disclaimer:
      'Tapping “Learn more” takes you to the provider’s website. Fuelyn may earn a commission if you sign up through our link. It has no effect on the price you pay.',
  },
  ...
  achievements: {
    ...
    items: {
      ...
      'streak-14':            { label: 'Smart streak: 14',    desc: 'Two weeks of nonstop bargains.' },
  ...
  bankImport: {
    ...
    desc: 'CSV from your bank (DKB / Sparkasse / ING / N26) → fuel log',
    cta: 'Pick CSV',
    busyCta: 'Reading …',
  ...
  hero: {
    ...
    headlinePart2: 'Not just the cheapest liter.',
    body: 'Allow location access for live prices near you — or take a look around Berlin first.',
  ...
  consumptionTracker: {
    ...
    formStation: 'Station',
    formStationPlaceholder: 'e.g., Shell Main St.',
    formFuel: 'Fuel',
    formLiters: 'Liters',
    formPrice: 'Price (€/L)',
