...
function defaultCommands(
  ...
  return [
    ...
    { id: 'partners', group: 'Experimental', label: 'Tank- & Ladekarten',
      hint: 'Beta — Loyalty-Anbindung nicht produktiv', icon: '💳',
      perform: () => router.push('/partners') },
    { id: 'wrapped', group: 'Experimental', label: 'Fuelyn Wrapped',
      hint: 'Beta — Dein Jahr in Zahlen', icon: '🎁',
      perform: () => router.push('/wrapped') },
    { id: 'achievements', group: 'Experimental', label: 'Achievements',
      hint: 'Beta — Gamification', icon: '🏆',
      perform: () => router.push('/achievements') },
    { id: 'ai-chat', group: 'Experimental', label: 'AI-Chat',
      hint: 'Beta — Q&A-Drawer', icon: '✨',
      perform: () => router.push('/ai-chat') },
