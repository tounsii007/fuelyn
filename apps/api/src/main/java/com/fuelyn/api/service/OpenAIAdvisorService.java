...
import com.fuelyn.api.model.dto.AIAdvisorRequest;
import com.fuelyn.api.model.dto.AIAdvisorResponse;
...
public class OpenAIAdvisorService {
    ...
    public OpenAIAdvisorService(
            ...
            @Value("${fuelyn.openai.api-key}") String apiKey,
            @Value("${fuelyn.openai.model}") String model,
            @Value("${fuelyn.openai.max-tokens}") int maxTokens) {
    ...
    private String buildSystemPrompt() {
        return """
                Du bist ein KI-Tankberater fuer die App "Fuelyn". \
